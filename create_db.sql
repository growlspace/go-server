...
CREATE TABLE users (user_id int PRIMARY KEY DEFAULT nextval('user_id_seq'), username varchar(10), password_hash text, password_salt text, email text, real_name text, bio text, created_at timestamp, updated_at timestamp);
...
INSERT INTO "users" (username, password_hash, password_salt, real_name, bio, created_at, updated_at) VALUES ('test', 'passwordlol', 'lol', 'john@mailinator.com', 'John Smith', 'hes a mean one', current_timestamp, current_timestamp);

INSERT INTO "users" (username, password_hash, password_salt, real_name, bio, created_at, updated_at) VALUES ('test2', 'passwordlol', 'lol', 'jane@mailinator.com', 'Jane Smith', 'shes a mean one', current_timestamp, current_timestamp);
